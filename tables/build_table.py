...
# The list of features used in UD 2.18 is needed or generated the right Grew pattern for the MISC case
...
parser.add_argument("-s", "--suffix", default="@2.18", help = "The suffix used in Grew-match naming of the corpus")
...
def pattern (x):
    if args.columns == "DEPS":
        ...
        prefix = "__MISC__" if x in ud_feats_2_18 else ""
